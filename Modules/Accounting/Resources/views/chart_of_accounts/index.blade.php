...
<section class="content">
        ...
        <div class="container">
            <ul class="nav nav-tabs nav-justified my-custom-tabs">
                <li class="nav-item">
                    <label class="btn btn-info nav-link " >
                        <input type="radio" name="view_type" value="table" class="view_type hidden">
                        <i class="fas fa-table"></i> <span class="hidden md:inline">@lang('accounting::lang.tabular_view')</span>
                    </label>
                </li>
                <li class="nav-item">
                    <label class="btn btn-info nav-link">
                        <input type="radio" name="view_type" value="tree" class="view_type hidden">
                        <i class="fas fa-list-ul"></i> <span class="hidden md:inline">@lang('accounting::lang.tree_view')</span>
                    </label>
                </li>
            </ul>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @slot('tool')
            <div class="card-body">
                <a class="btn btn-dark m-5 btn-modal" 
...
<div class="modal " id="create_account_modal" tabindex="-1" role="dialog">
</div>
@stop
@section('javascript')
