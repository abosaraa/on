            ...
            <div class="col-sm-3">
				<div class="form-group">
					...
					<div class="input-group">
                        ...
                        {!! Form::text('journal_date', @format_datetime('now'), ['class' => 'form-control datetimepicker', 'required', 'data-target' => '#datetimepicker']) !!}
                        {{-- {!! Form::text('journal_date', null, ['class' => 'form-control datetimepicker', 'required', 'data-target' => '#datetimepicker', 'placeholder' => 'YYYY-MM-DD HH:mm:ss']) !!} --}}
            ...
            <table class="table table-bordered table-striped hide-footer" id="journal_table">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <button type="button" id="addRow" class="btn btn-primary pull-right btn-flat">@lang('accounting::lang.add_more_row')</button>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
