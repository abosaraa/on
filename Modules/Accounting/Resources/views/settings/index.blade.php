			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="account_setting">
						...
						<div class="row mb-12">
							<div class="col-md-4">
								<button type="button" class="btn btn-danger accounting_reset_data" data-href="{{action([\Modules\Accounting\Http\Controllers\SettingsController::class, 'resetData'])}}">
						...
						<h3>@lang('accounting::lang.map_transactions') </h3>
						...
						<div class="row">
							<div class="col-md-12 text-center">
								<div class="form-group">
									{{Form::submit(__('messages.update'), ['class'=>"btn btn-primary btn-big rounded"])}}
								</div>
							</div>
						</div>
						{!! Form::close() !!}
					...
					<div class="tab-pane" id="sub_type_tab">
						<div class="row">
							<div class="col-md-12">
								<button class="btn btn-dark	" id="add_account_sub_type">
							...
							<div class="col-md-12">
								...
								<div class="table-responsive">
									<table class="table table-bordered " id="account_sub_type_table"  style="width: 100%;">
										<thead>
											<tr>
												<th>
													@lang('accounting::lang.account_sub_type')
					...
					<div class="tab-pane" id="detail_type_tab">
						<div class="row">
							<div class="col-md-12">
								<button class="btn btn-dark " id="add_detail_type">
									<i class="fas fa-plus"></i> @lang('messages.add')
								</button>
							</div>
							<div class="col-md-12">
								...
								<table class="table table-bordered" id="detail_type_table" style="width: 100%;">
									<thead>
										<tr>
											<th>
												@lang('accounting::lang.detail_type')
...
<div class="modal " id="edit_account_type_modal" tabindex="-1" role="dialog">
</div>

<div class="modal " id="add_account_sub_type" tabindex="-1" role="dialog">
</div>

<div class="modal " id="add_detail_type" tabindex="-1" role="dialog">
</div>
@stop
