...
@section('content')
		...
		<div class="card card-solid">
			<div class="card-header with-border">
				...
				<div class="card-tools pull-right">
					<a type="button" class="btn btn-sm btn-primary" data-href="{{action([\Modules\AssetManagement\Http\Controllers\AssetController::class, 'create'])}}" id="add_asset">
			...
			<div class="card-body">
				<div class="table-responsive">
					<table class="table table-bordered    " id="assest_table">
						<thead>
							<tr>
	...
	<div class="modal " id="asset_modal" tabindex="-1" role="dialog"></div>
	<div class="modal " id="allocate_asset_modal" tabindex="-1" role="dialog"></div>
	<div class="modal " id="asset_maintenance_modal" tabindex="-1" role="dialog"></div>
@stop
@section('javascript')
