...
@section('content')
		...
		<div class="card card-solid">
			<div class="card-header with-border">
				<div class="card-tools pull-right">
					<a class="btn btn-sm btn-primary" id="allocate_asset" data-href="{{action([\Modules\AssetManagement\Http\Controllers\AssetAllocationController::class, 'create'])}}">
			...
			<div class="card-body">
				<div class="table-responsive">
					<table class="table table-bordered    " id="assest_allocated_table">
						<thead>
							<tr>
	...
	<div class="modal " id="asset_revoke_modal" tabindex="-1" role="dialog"></div>
	<div class="modal " id="allocate_asset_modal" tabindex="-1" role="dialog"></div>
	<div class="modal " id="edit_allocate_asset_modal" tabindex="-1" role="dialog"></div>
@stop
@section('javascript')
