		...
		<div class="col-md-4 col-sm-6 col-xs-12 col-custom">
			<div class="card card-solid">
				<div class="card-header with-border">
	                ...
	                <h3 class="card-title">@lang('essentials::lang.my_leaves')</h3>
	            </div>
		...
		<div class="col-md-4 col-sm-6 col-xs-12 col-custom">
			<div class="card card-solid">
				<div class="card-header with-border">
	                ...
	                <h3 class="card-title">@lang('essentials::lang.my_sales_targets')</h3>
	            </div>
                <div class="card-body p-10">
                    <table class="table no-margin">
                    	<thead>
    	...
    	@if($is_admin)
	        ...
	        <div class="col-md-8 col-sm-12 col-xs-12">
	        	<div class="card card-solid">
	        		<div class="card-header with-border">
	                    <i class="fas fa-bullseye"></i>
	                    <h3 class="card-title">@lang('essentials::lang.sales_targets')</h3>
	                </div>
	                <div class="card-body">
