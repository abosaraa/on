	...
	<section class="content">
		<div class="card card-solid">
			<div class="card-header">
				<h4 class="card-title">@lang('essentials::lang.knowledge_base')</h4>
			...
			<div class="card-body">
				...
				@foreach($knowledge_bases as $kb)
					<div class="col-md-4">
						<div class="card card-solid" style="max-height: 500px; overflow-y: auto;">
							<div class="card-header">
								<h4 class="card-title">{{$kb->title}}</h4>
								<div class="card-tools pull-right">
								...
								@if(count($kb->children) > 0)
									<div class="card-group" 
										...
										@foreach($kb->children as $section)
											<div class="panel card card-solid">
												<div class="card-header with-border" style="padding: 10px 12px;">
													<h4 class="card-title">
