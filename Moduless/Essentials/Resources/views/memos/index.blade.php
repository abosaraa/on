...
<section class="content">
	<h4>
		...
		<div class="card card-solid">
			<div class="card-header">
				<h4 class="card-title">@lang('essentials::lang.all_memos')</h4>
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<table class="table table-bordered     documents">
						<thead>
							<tr>
	...
	<div class="modal  document" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"></div>
	<!-- memos view model -->
	<div class="modal  memos" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"></div>
@endsection
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(document).on('click', '.add_memo', function(){
			$("form#upload_document_form").In();
		});

		//form cancel_btn
	    $(document).on('click', '.cancel_btn', function(){
	    	$("form#upload_document_form")[0].reset();
			$("form#upload_document_form").Out();
	    });
