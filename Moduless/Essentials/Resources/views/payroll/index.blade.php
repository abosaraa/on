...
<section class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table table-bordered    " id="payrolls_table" style="width: 100%;">
                                        <thead>
                                            <tr>
                    ...
                    @can('essentials.view_all_payroll')
                        <div class="tab-pane" id="payroll_group_tab">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered    " id="payroll_group_table" style="width: 100%;">
                                            <thead>
                                                <tr>
                    ...
                    @if(auth()->user()->can('essentials.view_allowance_and_deduction') || auth()->user()->can('essentials.add_allowance_and_deduction'))
                        <div class="tab-pane" id="pay_component_tab">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered    " id="ad_pc_table" style="width: 100%;">
                                            <thead>
                                                <tr>
    ...
    @endcan
    <div class="modal " id="add_allowance_deduction_modal" tabindex="-1" role="dialog"
