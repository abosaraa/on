...
<hr>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! Form::label('system_id',' Installment Plan:') !!}
            ...
            ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            {!! Form::label('period',' Payment rate:') !!}
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <span style="color: red" id="benefit-type">Interest value for each year</span>
                        </div>
                    </div>
    ...
    <div class="col-lg-4">
        <div class="form-group">
            {!! Form::label('latfines','Delay Penalty % :') !!}
        ...
        <select class="form-control" name="latfinestype" id="latfinestype">
            ...
            <option value="year">@lang('installment::lang.year')</option>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            {!! Form::label('installmentdate','First installment date: ') !!}
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            {!! Form::label('benefit_value','Total benefit :') !!}
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            {!! Form::label('total','Total Payment :') !!}
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            {!! Form::label('installment','Installment amount:') !!}
