...
<section class="content">
	...
	<div class="card card-solid">
		<div class="card-header"> 
			<h4 class="card-title"><strong>@lang('sale.product'): </strong>{{$variation->product_name}} @if($variation->product_type == 'variable') - {{$variation->product_variation_name}} - {{$variation->name}} @endif</h4>
		</div>
		<div class="card-body">
			<div class="row">
				<div class="col-md-12">
			...
			<div class="row">
				<div class="col-md-12">
					<table class="table     table-th-green text-center ingredients_table">
						<thead>
							<tr>
