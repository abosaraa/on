		...
		{!! Form::open(['url' => action([\Modules\Repair\Http\Controllers\JobSheetController::class, 'updateStatus'], [$job_sheet->id]), 'method' => 'put', 'id' => 'update_status_form']) !!}
          ...
          <button type="button" class="btn custom-close-btn" data-bs-dismiss="modal" aria-label="Close">
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-success ladda-button update_status_button mark-as-incomplete-btn" data-href="{{action([\Modules\Repair\Http\Controllers\JobSheetController::class, 'addParts'], [$job_sheet->id])}}">@lang( 'repair::lang.save_and_add_parts' )</button>
