            ...
            <div class="box box-solid">
                <div class="box-header no-print">
                    <div class="box-tools">
                        ...
                        <a href="{{action([\Modules\Repair\Http\Controllers\JobSheetController::class, 'edit'], [$job_sheet->id])}}" class="btn btn-info cursor-pointer">
                        ...
                        <a class="btn btn-success" href="{{action([\Modules\Repair\Http\Controllers\JobSheetController::class, 'print'], [$job_sheet->id])}}" target="_blank">
                            <i class="fas fa-file-pdf"></i>
                            @lang( 'repair::lang.print_format_2' )
                        </a>

                        <a class="btn btn-warning" href="{{action([\Modules\Repair\Http\Controllers\JobSheetController::class, 'printLabel'], [$job_sheet->id])}}" target="_blank">
