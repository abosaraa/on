                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="pending_repair_tab">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered    ajax_view" id="pending_repair_table">
                                <thead>
                                    <tr>
                    ...
                    <div class="tab-pane" id="completed_repair_tab">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered    ajax_view" id="sell_table">
                                <thead>
                                    <tr>
                                        <th>@lang('messages.action')</th>
                                        <th>@lang('receipt.date')</th>
...
$(document).ready( function(){
    ...
    $(document).on('click', '.collapsed-card-title', function(e){
        if (e.target.tagName == 'BUTTON' || e.target.tagName == 'I') {
            return false;
        }
        $(this).find('.card-tools button').click();
    });
