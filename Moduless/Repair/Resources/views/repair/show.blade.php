...
<div class="modal-body">
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div class="card card-default card-solid collapsed-card">
            <div class="card-header with-border collapsed-card-title" style="cursor: pointer;">
                <h3 class="card-title">{{ __('repair::lang.pre_repair_checklist') }}:</h3>
      ...
      <div class="col-sm-6">
        <div class="card card-default card-solid collapsed-card">
            <div class="card-header with-border collapsed-card-title" style="cursor: pointer;">
                <h3 class="card-title">{{ __('sale.payment_info') }}:</h3>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-default card-solid collapsed-card">
                <div class="card-header with-border collapsed-card-title" style="cursor: pointer;">
                    <h3 class="card-title">{{ __('repair::lang.activities') }}:</h3>
        ...
        <div class="col-md-6">
            <div class="card card-default card-solid collapsed-card">
                <div class="card-header with-border collapsed-card-title" style="cursor: pointer;">
                    <h3 class="card-title">{{ __('lang_v1.documents') }}:</h3>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-default card-solid collapsed-card">
                <div class="card-header with-border collapsed-card-title" style="cursor: pointer;">
                    <h3 class="card-title">{{ __('repair::lang.pass_code_of_device') }}:</h3>
