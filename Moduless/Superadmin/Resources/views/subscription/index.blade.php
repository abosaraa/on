...
<section class="content">
	...
	<div class="card">
        <div class="card-header">
            <h3 class="card-title">@lang('superadmin::lang.active_subscription') </h3>
        </div>
        		...
        		@foreach($nexts as $next)
        			<div class="col-md-4">
		        		<div class="card card-success">
							...
							<div class="card-footer bg-gray disabled text-center">
								
								<a href="{{ route('force-active', $next->id) }}"
								class="btn btn-sm btn-success force_activate_now">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">@lang('superadmin::lang.all_subscriptions')</h3>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">@lang('superadmin::lang.packages')</h3>
        </div>
