        ...
        if (request()->ajax()) {
            ...
            return DataTables::of($accounts)
                            ->addColumn(
                                ...
                                @if($is_closed == 0)
                                <button data-href="{{action(\'App\Http\Controllers\AccountController@getFundTransfer\',[$id])}}" class="btn btn-xs btn-dark btn-modal" data-container=".view_modal"><i class="fa fa-exchange"></i> @lang("account.fund_transfer")</button>
