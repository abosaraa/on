...
$transaction_details = Transaction::where('transactions.created_by', $user_id)
                ...
                ->select(
                    ...
                    DB::raw('SUM(CASE WHEN transactions.type = "sell" THEN final_total ELSE 0 END) as total_sales'),
                    DB::raw('SUM(CASE WHEN transactions.type = "sell_return" THEN final_total ELSE 0 END) as total_sales_return1'),
