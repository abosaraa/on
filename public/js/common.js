...
$(document).ready(function () {
    ...
    var buttons = [
        // {
        //     extend: 'copy',
        //     text: '<img src="https://demo.bardpos.com/img/icons/export.svg" alt="Export to Excel" title="Export to Excel" data-toggle="tooltip" data-placement="bottom" data-original-title="Export to Excel"></img>',
...
,        
        {
            extend: 'print',
            text: '<img src="https://demo.bardpos.com/img/icons/printer.svg" alt="" title="Print" data-toggle="tooltip" data-placement="bottom" data-original-title="Print" aria-describedby="tooltip881074">',
            className: 'btn btn-default  buttons-html5 btn-sm',
            exportOptions: {
                columns: ':visible',
                stripHtml: true,
            },
        ...
        {
            extend: 'colvis',
            text: '<i class="fa fas fa-columns fa-2x"></i>',
            className: 'btn-sm',
        },
    ];
    ...
    var pdf_btn = {
        extend: 'pdf',
        text: '<img src="https://demo.bardpos.com/img/icons/pdf.svg" alt="" title="Export to PDF" data-toggle="tooltip" data-placement="bottom" data-original-title="Export to PDF" aria-describedby="tooltip152936">',
        className: 'btn btn-default  buttons-html5 btn-sm',
        exportOptions: {
            columns: ':visible',
        },
