...
<section class="content-header ">    <h1>@lang('lang_v1.payment_accounts')
...
<section class="content">
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                        ...
                        <div class="row">
                            ...
                            <br>
                                <div class="table-responsive">
                                    <table class="table table-bordered  " id="other_account_table">
                                        <thead>
                                            <tr>
                    ...
                    <div class="tab-pane" id="capital_accounts">
                        <table class="table table-bordered  " id="capital_account_table" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>@lang( 'lang_v1.name' )</th>
                                    <th>@lang('account.account_number')</th>
                    ...
                    <div class="tab-pane" id="account_types">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table   table-bordered" id="account_types_table" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>@lang( 'lang_v1.name' )</th>
                                            <th>@lang( 'messages.action' )</th>
    ...
    <div class="modal  account_model" tabindex="-1" role="dialog" 
