...
<div class="container">
    {{-- <div class="row">
        <div class="col-md-12 col-sm-12 @if(!empty($for_pdf)) width-100 text-right @endif">
            <p class="text-right align-right"><strong>{{$contact->business->name}}</strong><br>
                @if(!empty($location))
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 text-right align-right @if(!empty($for_pdf)) width-100 float-left @endif">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 @if(!empty($for_pdf)) width-100 @endif">
            ...
            <div class="table-responsive">
                <table class="table @if(!empty($for_pdf)) table-pdf @endif" id="ledger_table">
                    <thead>
