    ...
    <div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                {!! Form::select('ledger_location', $business_locations, null , ['class' => 'form-control  nice-select2', 'id' => 'ledger_location']); !!}
            </div>
        </div>
        <div class="col-md-12 text-right">
            <button data-href="{{action([\App\Http\Controllers\ContactController::class, 'getLedger'])}}?contact_id={{$contact->id}}&action=pdf" class="btn btn-default btn-xs" id="print_ledger_pdf"><i class="fas fa-file-pdf btn btn-primary btn-sm"></i></button>

            <button type="button" class="btn btn-dark btn-sm" id="send_ledger"><i class="fas fa-envelope"></i></button>
        </div>
    </div>
