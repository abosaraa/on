...
<section class="content no-print">
    <div class="row no-print">
        ...
        <div class="col-md-4 col-xs-12 mt-15 pull-right mt-5">
            {!! Form::select('contact_id', $contact_dropdown, $contact->id , ['class' => 'form-control ', 'id' => 'contact_id']); !!}
        </div>
    </div>
...
<div class="modal " id="edit_ledger_discount_modal" tabindex="-1" role="dialog" 
        aria-labelledby="gridSystemModalLabel">
</div>
...
function get_contact_payments(url = null) {
    ...
    $.ajax({
        ...
        dataType: 'html',
        success: function(result) {
            $('#contact_payments_div').Out(400, function(){
...
function get_contact_ledger() {
    ...
    success: function(result) {
        $('#contact_ledger_div')
            .html(result)
            .addClass('table-responsive'); // Add table-responsive class
