...
<section class="content-header ">    <h1>@lang( 'lang_v1.customer_groups' )</h1>
    <!-- <ol class="breadcrumb">
...
<section class="content">
    @component('components.widget', ['class' => 'box-primary', 'title' => __( 'lang_v1.all_your_customer_groups' )])
        ...
        @can('customer.view')
            <div class="table-responsive">
                <table class="table table-bordered  " id="customer_groups_table">
                    <thead>
                        <tr>
    ...
    <div class="modal  customer_groups_modal" tabindex="-1" role="dialog" 
