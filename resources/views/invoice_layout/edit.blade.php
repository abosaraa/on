...
{{-- <section class="content-header ">    <h1>@lang('invoice.edit_invoice_layout')</h1>
</section> --}}
    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="clearfix"></div>
            ...
            <div class="col-sm-12 letter_head_input">
                <div class="form-group">
      ...
      <div class="row hide-for-letterhead">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('show_logo', 1, $invoice_layout->show_logo, ['class' => 'input-icheck', 'id' => 'show_logo']); !!} 
...
<script>
  $(document).ready(function() {
      // Initialize iCheck for all checkboxes with class 'input-icheck'
      $('input.input-icheck').iCheck({
          checkboxClass: 'icheckbox_square-blue',
          radioClass: 'iradio_square-blue',
      });
  
      // Toggle visibility of logo section based on logo checkbox
      // $('#show_logo').on('ifChanged', function() {
      //     $('.hide-for-letterhead').toggleClass('hide', !$(this).prop('checked'));
      // });
  
      // Toggle visibility of letter section based on letter checkbox
      $('#show_letter_head').on('ifChanged', function() {
          $('.letter_head_input').toggleClass('hide', !$(this).prop('checked'));
      });
  
      // Trigger initial check to set visibility based on the checkbox state
      // $('#show_logo').trigger('ifChanged');
      $('#show_letter_head').trigger('ifChanged');

         // Toggle visibility of logo section based on logo checkbox
      $('#show_logo').on('ifChanged', function() {
        // Toggle the visibility of the logo section based on the checkbox state
        // For example, if you want to show/hide a specific element with the class 'logo-section':
        $('.logo-section').toggleClass('hide', !$(this).prop('checked'));
      });
