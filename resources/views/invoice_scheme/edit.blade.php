<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <button type="button" class="btn custom-close-btn" data-dismiss="modal" aria-label="Close">
                ...
                <div id="invoice_format_settings">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group col-md-12 col-md-12">
                    ...
                    <div class="col-md-12 sequential_field @if($invoice->number_type == 'random') hide @endif">
                        <div class="form-group">
