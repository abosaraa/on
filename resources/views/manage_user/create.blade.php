                  ...
                  <div class="form-group mb-0 justify-content-end">
                      <div class="checkbox">
                          <div class="custom-checkbox custom-control">
                              <input type="checkbox" id="checkbox-2" class="custom-control-input status" checked>
                              <label for="checkbox-2" class="custom-control-label mt-1">{{ __('lang_v1.status_for_user') }}</label>
                          </div>
                      </div>
                  </div>
            ...
            <div class="card-body pt-0">
                ...
                <h4>@lang( 'role.access_locations' ) @show_tooltip(__('tooltip.access_locations_permission'))</h4>
                        ...
                        @foreach($locations as $location)
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('location_permissions[]', 'location.' . $location->id, false, ['class' => 'input-icheck']); !!} {{ $location->name }} @if(!empty($location->location_id))({{ $location->location_id}}) @endif
                                </label>
                            </div>
                        @endforeach
      ...
      <div class="card box-shadow-0">
          ...
          <div class="card-body pt-0">
              ...
              <div class="form-group">
                  <div class="checkbox">
                      <label>
                          {!! Form::checkbox('selected_contacts', 1, false, ['class' => 'form-check-input input-icheck', 'id' => 'selected_contacts']); !!}
              ...
              <div class="hide selected_contacts_div">
                  <div class="form-group">
...
{{-- مزيد من المعلومات --}}
  ...
  <div class="row">
    <div class="col-md-12 text-center">
      <button type="submit" class="btn btn-primary btn-raised-shadow btn-wave" id="submit_user_button">@lang( 'messages.save' )</button>
    </div>
  </div>
{!! Form::close() !!}
  @stop
