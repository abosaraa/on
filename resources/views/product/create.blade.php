...
{{-- <section class="content-header ">    <h1>@lang('product.add_new_product')</h1>
    <!-- <ol class="breadcrumb">
...
<section class="content">
    ...
    <div class="row">
        {{-- <div class="col-sm-3"></div> <!-- عمود فارغ لإضافة مسافة على اليمين --> --}}
        <div class="col-md-12">
            <input type="hidden" name="submit_type" id="submit_type">
            <div class="text-center">
                <div  style="white-space: nowrap;">
    
                    <!-- زر حفظ وإضافة أسعار مجموعة الأسعار -->
                    @if($selling_price_group_count)
                    <button type="submit" value="submit_n_add_selling_prices" class="btn btn-warning btn-sm submit_product_form rounded">
                        @lang('lang_v1.save_n_add_selling_price_group_prices')
                    </button>
                    @endif
                
                    <!-- زر حفظ وإضافة مخزون الافتتاح -->
                    @can('product.opening_stock')
                    <button id="opening_stock_button" @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) disabled @endif type="submit" value="submit_n_add_opening_stock" class="btn bg-purple btn-dark btn-default submit_product_form rounded ml-1">
                        @lang('lang_v1.save_n_add_opening_stock')
                    </button>
                    @endcan
                
                    <!-- زر حفظ وإضافة آخر -->
                    {{-- <button type="submit" value="save_n_add_another" class="btn bg-maroon btn-dark btn-sm submit_product_form rounded ml-1"> --}}
                        {{-- @lang('lang_v1.save_n_add_another')
                    </button> --}}
                
                    <!-- زر حفظ -->
                    <button type="submit" value="submit" class="btn btn-primary btn-default submit_product_form rounded ml-1">
                        @lang('messages.save')
                    </button>
                </div>
            </div>
        </div>
        {{-- <div class="col-sm-3"></div> <!-- عمود فارغ لإضافة مسافة على اليسار --> --}}
    </div>
