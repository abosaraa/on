...
@foreach($variations as $variation)
	<tr>
		...
		<td class="text-center">
			<div class="row">
				<div class="col-sm-12">
					{!! Form::text('quantity[]', @num_format($quantity), ['class' => 'form-control input-sm quantity input_number mousetrap', 'required', 'style' => 'width: 100%']); !!}
				</div>
		
				@if(!empty($sub_units))
					<div class="col-sm-12 mt-2">
						<select name="unit[]" class="form-control input-sm sub_unit" style="width: 100%;">
