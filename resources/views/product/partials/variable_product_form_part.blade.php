...
<div class="col-sm-12">
    ...
    <table class="table table-bordered add-product-price-table table-condensed" id="product_variation_form_part" style="width: 100% !important;">
        <thead>
          <tr>
            <th class="col-sm-2">@lang('lang_v1.variation')</th>
            <th class="col-sm-12">@lang('product.variation_values')</th>
          </tr>
        </thead>
        <tbody>
            @if($action == 'add')
