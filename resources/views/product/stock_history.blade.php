...
{{-- <section class="content-header ">    <h1>@lang('lang_v1.product_stock_history')</h1>
</section> --}}
    ...
    @component('components.widget', ['title' => $product->name])
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {!! Form::select('location_id', $business_locations, request()->input('location_id', null), ['class' => 'form-control ', 'style' => 'width:100%']); !!}
            </div>
        </div>
