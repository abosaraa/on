			...
			<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
				<div class="form-group">
					...
					<div class="input-group">
						...
						{!! Form::text('transaction_date', @format_datetime('now'), ['class' => 'form-control ', 'required' , 'readonly']); !!}
						{{-- {!! Form::text('transaction_date', date('Y-m-d H:i:s'), ['class' => 'form-control ', 'required']) !!} --}}
