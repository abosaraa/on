...
{{--     
    <button type="button" class="btn custom-close-btn " data-bs-dismiss="modal" aria-label="Close">
      <span aria-hidden="true" class="custom-close-icon no-print">&times;</span>
    </button> --}}
    ...
    @endphp
    <h4 class="modal-title" id="modalTitle">  (<b>@lang('purchase.ref_no'):</b> #{{ $purchase->ref_no }})
    </h4>
</div>
<div class="modal-body">
  ...
  <div class="row invoice-info table table-bordered  " style="width: 100% !important;">
    <div class="col-sm-6 invoice-col table-bordered ">
        <address>
...
{{-- 
  ...
  <div class="row">
    <div class="col-sm-12 col-xs-12">
      <div class="table-responsive">
        <table class="table bg-gray table-striped table-bordered">
          <thead>
            <tr class="bg-green">
              <th>#</th>
  ...
  <div class="row">
    ...
    @endif
    <div class="col-md-12 @if($purchase->type == 'purchase_order') col-md-offset-6 @endif">
      <div class="table-responsive">
        <table class="table table-striped table-bordered ">
          <!-- <tr class="hide">
