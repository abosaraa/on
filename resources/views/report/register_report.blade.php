...
<section class="content-header ">    <h1>{{ __('report.register_report')}}</h1>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.widget', ['class' => 'box-primary'])
                <table class="table table-bordered  " id="register_report_table">
                    <thead>
                        <tr>
...
<!-- /.content -->
<div class="modal   view_register" tabindex="-1" role="dialog" 
