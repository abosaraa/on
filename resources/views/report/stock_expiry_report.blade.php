...
<section class="content-header ">    <h1>{{ __('report.stock_expiry_report')}}</h1>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="table-responsive">
                <table class="table table-bordered  " id="stock_expiry_report_table">
                    <thead>
                        <tr>
...
<div class="modal   exp_update_modal" tabindex="-1" role="dialog">
</div>
@endsection
