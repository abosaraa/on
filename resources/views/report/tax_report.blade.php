...
{{-- <section class="content-header ">    <h1>@lang( 'report.tax_report' )
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="input_tax_tab">
                        <table class="table table-bordered  " id="input_tax_table">
                            <thead>
                                <tr>
                    ...
                    <div class="tab-pane" id="output_tax_tab">
                        <table class="table table-bordered  " id="output_tax_table" width="100%">
                            <thead>
                                <tr>
                                    <th>@lang('messages.date')</th>
                    ...
                    <div class="tab-pane" id="expense_tax_tab">
                        <table class="table table-bordered  " id="expense_tax_table" width="100%">
                            <thead>
                                <tr>
                                    <th>@lang('messages.date')</th>
                                    <th>@lang('purchase.ref_no')</th>
