...
<section class="content-header ">    <h1>@lang( 'restaurant.modifier_sets' )
...
<section class="content">
	...
	<div class="box">
        ...
        <div class="card-body">
            @can('restaurant.view')
            	<table class="table table-bordered  " id="modifier_table">
            		<thead>
            			<tr>
    ...
    <div class="modal   modifier_modal" tabindex="-1" role="dialog" 
