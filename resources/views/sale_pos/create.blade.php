...
<section class="main   no-print">
	...
	<div class="row mb-12">
		<div class="col-md-12">
			<div class="row">
				<div class="@if(empty($pos_settings['hide_product_suggestion'])) col-md-8 @else col-md-10 col-md-offset-1 @endif no-padding pr-10">
					<div class="card card-solid mb-12 @if(!isMobile()) mb-40 @endif">
				...
				<div class="col-md-4 card card-soild no-padding ">
