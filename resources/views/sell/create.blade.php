		...
		<div class="col-md-12 col-sm-12">
			<div class="row">
				<div class="col-md-12">
					...
					@if(in_array('types_of_service', $enabled_modules) && !empty($types_of_service))
						...
						{{-- </div> --}}
						<div class="modal  types_of_service_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel"></div>
					@endif
					...
					<div class="@if(!empty($commission_agent))  @else @endif">
						<div class="form-group">
					...
					{{-- </div> --}}
					@endif
					<div class="@if(!empty($commission_agent))col-md-3 @else  @endif">
						<div class="form-group">
			...
			@component('components.widget')
				...
				<div class="row col-sm-12 pos_product_div" style="min-height: 0">
					...
					<table class="table table-condensed table-bordered   table-responsive" id="pos_table" style="width: 100%;">
						<thead>
							<tr>
			...
			<div class="col-md-12 text-center">
				<button class="btn btn-danger " type="button" data-toggle="collapse" data-target="#more_btn3" aria-expanded="false" aria-controls="more_btn">اضافة خصم  </button>
			</div>
<div class="row collapse" id="more_btn3">
			...
			<div class="col-md-12 text-center">
				<button class="btn btn-danger " type="button" data-toggle="collapse" data-target="#more_btn" aria-expanded="false" aria-controls="more_btn">تفاصيل الشحن </button>
			</div>

		
			
			
			<div class="row collapse"  id="more_btn"> 
				<div class="col-md-4">
					<div class="form-group">
	...
	@if((empty($status) || (!in_array($status, ['quotation', 'draft'])) || $is_enabled_download_pdf) && $sale_type != 'sales_order')
		@can('sell.payments')
			@component('components.widget', ['class' => 'box-solid', 'id' => $payment_body_id])
			<div class="col-md-12 text-center">
				<button class="btn btn-dark " type="button" data-toggle="collapse" data-target="#more_btn1" aria-expanded="false" aria-controls="more_btn">اضافة قسط </button>
			</div>

			<div class="row collapse" id="more_btn1">
			@if($is_enabled_download_pdf)
				<div class="well row">
					<div class="col-md-6">
						<div class="form-group">
...
<!-- /.content -->
<div class="modal  register_details_modal" tabindex="-1" role="dialog" 
	aria-labelledby="gridSystemModalLabel">
</div>
<div class="modal  close_register_modal" tabindex="-1" role="dialog" 
	aria-labelledby="gridSystemModalLabel">
</div>
    ...
    $(document).ready(function () {
        ...
        $('#customer_id').on('change', function () {
            ...
            if ($(this).val() === '') {
                ...
                // You can add your custom logic or leave it empty
...
<script>
    $(document).ready(function(){
        $('#shipping_details_toggle').click(function(){
            $('#more_btn').toggle();
            var isExpanded = $('#more_btn').hasClass('in');
            if(isExpanded){
                $(this).html('تفاصيل الشحن  <i class="fas fa-chevron-down"></i>');
            } else {
                $(this).html('إخفاء تفاصيل الشحن  <i class="fas fa-chevron-up"></i>');
            }
        });
    });
</script>
