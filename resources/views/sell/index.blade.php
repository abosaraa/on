...
<!-- Main content -->
@section('content')
 @component('components.filters', ['title' => 'فلتر'])
    ...
    @component('components.widget')
        ...
        @php
         ...
         @endphp
            <table class="table table-bordered   table-striped table-info table-responsive" id="sell_table" style="width:100% !important;">
                <thead>
                    <tr>
