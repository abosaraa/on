        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('sell_list_filter_location_id', $business_locations, null, ['class' => 'form-control select2', 'style' => 'width:100%;display:inline-block;', 'placeholder' => __('lang_v1.all') ]); !!}
                </div>
            </div>
            @endif
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('sell_list_filter_payment_status', ['paid' => __('lang_v1.paid'), 'due' => __('lang_v1.due'), 'partial' => __('lang_v1.partial'), 'overdue' => __('lang_v1.overdue')], null, ['class' => 'form-control ', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
                </div>
            </div>
            @endif
                ...
                <div class="form-group">
                    <div class="checkbox">
                        <label>
                          ...
                          [ 'class' => 'input-icheck', 'id' => 'only_subscriptions' , 'style' => '']); !!} {{ __('lang_v1.subscriptions') }}
                        </label>
                    </div>
                </div>
            </div>
