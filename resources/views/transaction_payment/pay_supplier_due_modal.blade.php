<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">اضافه سند صرف</h4>
    </div>
    ...
    <div class="modal-body">
      ...
      <div class="row payment_row">
        ...
        <a class="btn ripple btn-primary text-center btn-block " data-toggle="collapse" href="#info" role="button" aria-expanded="false" aria-controls="more_div">
