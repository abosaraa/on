...
Route::get('/web/fatora', function () {
    return view('web.fatora');
})->name('fatora');
Route::get('/web/restrun', function () {
    return view('web.restrun');
})->name('restrun');
...
/*     Route::get('sales-commission-agents/create', [SalesCommissionAgentController::class, 'create'])->name('sales-commission-agents.create');
 */
    //Stock Transfer
